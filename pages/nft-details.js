...
const NFTDetails = () => {
  const { currentAccount, nftCurrency, buyNFT, isLoadingNFT } = useMarketNft();
      ...
      <div className="relative flex-1 flexCenter sm:px-4 p-12 border-r md:border-r-0 md:border-b dark:border-nft-black-1 border-nft-gray-1">
        <div className="relative w-557 h-557 minmd:w-2/3 minmd:h-2/3 sm:w-full sm:h-300">
          <img
            src={nft.image}
            alt="nft image"
            className="relative w-557 h-557 minmd:w-2/3 minmd:h-2/3 sm:w-full sm:h-300 rounded-xl shadow-lg"
          />
        </div>
      </div>
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase() ? (
            ...
            <Button
              ...
              classStyles="mr-5 sm:mr-0 rounded-xl sm:mb-5"
              handleClick={() => setPaymentModal((prev) => !prev)}
            />
          )}
        </div>
      </div>
          ...
          footer={
            <div className="flexCenter flex-col">
              <Button
                ...
                classStyles="rounded-xl sm:mb-5"
